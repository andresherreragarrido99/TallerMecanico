...
import java.util.regex.Pattern;
    ...
    public record Vehiculo(String marca, String modelo, String matricula) {
        private static final String MARCA_REGEX = "^(?!\\s)(?![A-Z]{2}-[A-Z]{2})(?=.*[A-Z])[A-Za-z0-9\\- ]{3,}(?<!\\s)$";
        private static final String MATRICULA_REGEX = "^[0-9]{4}[BCDFGHJKLMNPRSTVWXYZ]{3}$";
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof Vehiculo v)) return false;
            return Objects.equals(matricula , v.matricula);
        }
